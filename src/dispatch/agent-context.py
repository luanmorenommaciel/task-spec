...
commands = {
    ...
    "mesh": {"mutation": "optional repository-local control plane; exact behavior is subcommand-specific and all canonical lifecycle mutations call Task-Spec", "tokens": ["TASKMESH_ERROR=<code>", "TASKMESH_DRY_RUN"]},
