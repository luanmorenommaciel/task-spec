...
Spec written: /tmp/.../tasks/T-20260602-add-health-endpoint.md
  status: ready  outdir: /tmp/.../tasks  task_spec_version: 3.3.0
...
|---------|--------------|--------|
| older `task-spec vX.Y.Z` from `--version` | Old install path is shadowing | `which taskspec` — install the v3.3 copy or call by absolute path |
