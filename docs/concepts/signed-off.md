...
> **Related:** [agent-contract.md](agent-contract.md), [eval-driven-development.md](eval-driven-development.md), [task-spec-v1.md](../../spec/task-spec-v3.md), [../patterns/runnable-bash-evals.md](../patterns/runnable-bash-evals.md)
