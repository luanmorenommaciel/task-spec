...
agent: codex
parent: (none)
depends_on: [T-20260914-toolkit-cli]
supersedes: (none)
touches_paths: [SKILL.md, skills, harness, README.md]
creates_paths: [tests/test-toolkit-experience.sh]
...
Provide consistent harness chat skills and installed workflow guides. Preserve established interfaces and prove the requested behavior with the named regression check.
...
```bash
# eval_1: Provide consistent harness chat skills and installed workflow guides
eval_1() {
  bash tests/test-toolkit-experience.sh
}
...
success_criteria:
  - id: eval_1
    description: "Provide consistent harness chat skills and installed workflow guides"
    runnable: bash
